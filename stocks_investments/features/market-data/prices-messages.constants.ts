...
export const PRICES_ERROR_MESSAGES: Record<PricesErrorCode, string> = {
  ...
  INVALID_YEAR: "Closing prices can't be requested for that year.",
  ...
  PRICE_HISTORY_UNAVAILABLE: "Those closing prices are older than the history the market data plan provides.",
